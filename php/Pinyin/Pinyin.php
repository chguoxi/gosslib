...
class Pingyin {
	...
	public function pinyin($_String, $pix = '', $_Code='utf8')
	{
		...
		for($i=0; $i<strlen($_String); $i++)
		{
			...
			$_Res .= $this->_Pinyin($_P, $_Data).$pix;
		}
	 ...
	 * 获取中文字符串的首字母
	 * 
	 * @param string $string 中文或英文
	 * @return string
	 */
	public function getFirstChar($string){
		$quanpin = $this->pinyin($string);
		return strtoupper($quanpin[0]);
	}
